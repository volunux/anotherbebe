...
$getHash.open('POST' , '/uploader/sign/photo/' + data.photo.name + '/');
...
$myData.date.length < 15 && $myData.century.length < 40 && $myData.genre.length < 40 && $myData.country.length < 40 && $myData.continent.length < 40 && $myData.region.length < 40 && $myData.about.length < 2000

&& $myData.ethnic_group.length < 40 && $myData.about.length > 10 && $myData.artist.length < 40 && $myData.findspot.length < 40 && $myData.medium.length < 40  && $myData.credit.length < 40 
...
&& $myData.ethnic_group.length < 40 && $myData.about.length > 10 && $myData.artist.length < 40 && $myData.findspot.length < 40 && $myData.medium.length < 40  && $myData.credit.length < 40 && $myData.photo
