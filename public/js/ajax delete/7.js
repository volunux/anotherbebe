...
$.ajax({
            ...
            'data' : {'keys' : [{'Key' : '12212121'} , {'Key' : '2323283982'}]} ,
...
window.onunload = function(e) {
  ...
  // objectKeys.push({'Key' : '6969'});



                      $.post(`/delete/objects` , {

                                        'Keys' : ['objectKeys' , 'asksakj']
                      } , (data) => {
...
var $formProcess = $('#formSubmit') , $links = $('#link').val() , $title = '' , data = {} , rmethod = $('#rmethod').val() , objectKeys = [] , $body = '' , removedKeys = '';
