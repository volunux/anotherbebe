...
router.get('/photo/d/:photo/comment/d/:comment/reply/d/:reply/update'					,														photoCtrl.entryReplyUpdate);

router.put('/photo/d/:photo/comment/d/:comment/reply/d/:reply'								,														photoCtrl.entryReplyUpdateSubmit);



router.get('/art/d/:article/comment/d/:comment/reply/d/:reply/update'					,														artCtrl.entryReplyUpdate);

router.put('/art/d/:article/comment/d/:comment/reply/d/:reply'								,														artCtrl.entryReplyUpdateSubmit);
