...
router.get('/photo/d/:photo/comment/add'												,														photoCtrl.entryAddComment);

router.post('/photo/d/:photo/comment'														,														photoCtrl.entryAddCommentSubmit);



router.get('/art/d/:article/comment/add'												,														artCtrl.entryAddComment);

router.post('/art/d/:article/comment'														,														artCtrl.entryAddCommentSubmit);
