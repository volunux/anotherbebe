															...
															'title' : {
																			...
																			'country' : {
																										'type' : Schema.Types.ObjectId ,
																																											'ref' : 'Country' ,
																																																					'autopopulate' : true , 'required' : [true , 'Country ID for War should be provided.'] ,
																										'validate' : {
																																		'isAsync' : true ,
																																												'validator' : (v) => {
																					...
																					'ethnic_group' : {
																															'type' : Schema.Types.ObjectId ,
																																																'ref' : 'Eyon' ,
																																																									'autopopulate' : true , 'required' : [true , 'Ethnic Group ID for War should be provided.'] ,
																										'validate' : {
																																		'isAsync' : true ,
																																												'validator' : (v) => {
																						...
																						'author' : {
																													'type' : Schema.Types.ObjectId ,
																																														'ref' : 'User' ,
																																																							'autopopulate' : true , 'required' : [true , 'User ID for War should be provided.'] ,
																								'validate' : {
																																'isAsync' : true ,
																																										'validator' : (v) => {
																							...
																							'main_body' : {
																															'type' : String ,
																																								'maxlength' : [6000 , 'War body cannot be greater than 6000 characters in length.'] ,

																																									'required' : [true , 'War body cannot be empty and should be provided.'] ,
								
																																										'minlength' : [10 , 'War body cannot be less than 1 character in length.']			} ,
...
warSchema.plugin(require('mongoose-autopopulate'));
