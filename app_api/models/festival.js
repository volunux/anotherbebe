...
var festivalSchema = new Schema({
																	'title' : {
																								'type' : String ,
																																	'maxlength' : [120 , 'Title cannot be greater 120 characters in length.'] ,
																			...
																			'country' : {
																										'type' : Schema.Types.ObjectId ,
																																											'ref' : 'Country' ,
																																																					'autopopulate' : true , 'required' : [true , 'Country ID for Festival should be provided.'] ,
																										'validate' : {
																																		'isAsync' : true ,
																																												'validator' : (v) => {
																					...
																					'ethnic_group' : {
																															'type' : Schema.Types.ObjectId ,
																																																'ref' : 'Eyon' ,
																																																									'autopopulate' : true , 'required' : [true , 'Ethnic ID for Festival should be provided.'] ,
																												'validate' : {
																																				'isAsync' : true ,
																																														'validator' : (v) => {
																								...
																								'author' : {
																															'type' : Schema.Types.ObjectId ,
																																																'ref' : 'User' ,
																																																									'autopopulate' : true , 'required' : [true , 'User ID for Festival should be provided.'] ,
																										'validate' : {
																																		'isAsync' : true ,
																																												'validator' : (v) => {
																											...
																											'main_body' : {
																																			'type' : String ,
																																												'maxlength' : [6000 , 'Festival body cannot be greater than 6000 characters in length.'] ,
																																												
																																												'required' : [true , 'Festival body cannot be empty and should be provided.'] ,
																																												
																																												'minlength' : [10 , 'Festival body cannot be less than 1 character in length.']			} ,
																													'url' : {
																																			'type' : String ,
																																												'slug' : 'title' ,
																																																						'unique' : true ,
