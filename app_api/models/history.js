...
var historySchema = new Schema({
																	'title' : {
																							'type' : String ,
																																...
																																'minlength' : [1 , 'Title cannot be less than 10 characters in length.']			} ,

																		'ethnic_group' : {
																												'type' : Schema.Types.ObjectId ,
																																													'ref' : 'Eyon' ,
																																																						'autopopulate' : true , 'required' : [true , 'Ethnic ID for History should be provided.'] ,
																									'validate' : {
																																	'isAsync' : true ,
																																											'validator' : (v) => {
																				...
																				'author' : {
																											'type' : Schema.Types.ObjectId ,
																																												'ref' : 'User' ,
																																																					'autopopulate' : true , 'required' : [true , 'User ID for History should be provided.'] ,
																						'validate' : {
																														'isAsync' : true ,
																																								'validator' : (v) => {
																					...
																					'main_body' : {
																													'type' : String ,
																																						'maxlength' : [6000 , 'History body cannot be greater than 6000 characters in length.'] ,

																																						'required' : [true , 'History body cannot be empty and shoule be provided.'] ,
																																						
																																						'minlength' : [10 , 'History body cannot be less than 10 characters in length.']			} ,
																						'url' : {
																											'type' : String ,
																																				'slug' : 'title' ,
																																														'unique' : true ,
