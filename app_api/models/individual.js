																		...
																		'title' : {
																			...
																			'ethnic_group' : {
																													'type' : Schema.Types.ObjectId ,
																																														'ref' : 'Eyon' ,
																																																							'autopopulate' : true , 'required' : [true , 'Ethnic ID for Individual should be provided.'] ,
																										'validate' : {
																																		'isAsync' : true ,
																																												'validator' : (v) => {
																				...
																				'author' : {
																											'type' : Schema.Types.ObjectId ,
																																												'ref' : 'User' ,
																																																					'autopopulate' : true , 'required' : [true , 'User ID for Individual should be provided.'] ,
																						'validate' : {
																														'isAsync' : true ,
																																								'validator' : (v) => {
																					...
																					'main_body' : {
																													'type' : String ,
																																						'maxlength' : [6000 , 'Individual body cannot be greater than 6000 characters in length.'] ,
																																						
																																						'required' : [true , 'Individual body cannot be empty and should be provided.'] ,
																																						
																																						'minlength' : [10 , 'Individual body cannot be less than 10 characters in length.']			} ,
																							'url' : {
																													'type' : String ,
																																						'slug' : 'title' ,
																																																'unique' : true ,
...
individualSchema.plugin(require('mongoose-autopopulate'));
