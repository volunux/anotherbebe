...
var mythologySchema = new Schema({
																	'title' : {
																							'type' : String ,
																		...
																		'ethnic_group' : {
																												'type' : Schema.Types.ObjectId ,
																																													'ref' : 'Eyon' ,
																																																						'autopopulate' : true , 'required' : [true , 'Ethnic ID for Mythology should be provided.'] ,
																									'validate' : {
																																	'isAsync' : true ,
																																											'validator' : (v) => {
																				...
																				'author' : {
																											'type' : Schema.Types.ObjectId ,
																																												'ref' : 'User' ,
																																																					'autopopulate' : true , 'required' : [true , 'User ID for Mythology should be provided.'] ,
																						'validate' : {
																														'isAsync' : true ,
																																								'validator' : (v) => {
																						...
																						'main_body' : {
																														'type' : String ,
																																							'maxlength' : [6000 , 'Mythology body cannot be greater than 6000 characters in length.'] ,

																																							'required' : [true , 'Mythology body cannot be empty and should be provided.'] ,

																																							'minlength' : [10 , 'Mythology body cannot be less than 10 characters in length.']			} ,
																							'url' : {
																												'type' : String ,
																																					'slug' : 'title' ,
																																															'unique' : true ,
...
mythologySchema.plugin(require('mongoose-autopopulate'));
