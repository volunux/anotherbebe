...
var soundSchema = new Schema({
																	'title' : {
																		...
																		'date' : {
																								'type' : String , 
																																	'maxlength' : [15 , 'Date of Sound cannot be greater than 15 characters in length.'] ,

																																		'required' : [true , 'Date of Sound should be provided and cannot be empty.'] ,

																																			'minlength' : [1 , 'Date of Sound cannot be less than 1 character in length.'] } ,

																			'century' : {	
																										'type' : Schema.Types.ObjectId ,	
																																											'ref' : 'Century' ,
																																																					'autopopulate' : true  , 'required' : [true , 'Century ID for Sound should be provided.'] ,
																									'validate' : {
																																	'isAsync' : true ,
																																											'validator' : (v) => {
																				...
																				'genre' : {	
																										'type' : Schema.Types.ObjectId ,	
																																											'ref' : 'Genre' ,
																																																				'autopopulate' : true  , 'required' : [true , 'Genre ID for Sound should be provided.'] ,
																									'validate' : {
																																	'isAsync' : true ,
																																											'validator' : (v) => {
																					...
																					'country' : {	
																													'type' : Schema.Types.ObjectId ,	
																																													'ref' : 'Country' ,
																																																							'autopopulate' : true  , 'required' : [true , 'Country ID for Sound should be provided.'] ,
																											'validate' : {
																																			'isAsync' : true ,
																																													'validator' : (v) => {
																						...
																						'continent' : {	
																														'type' : Schema.Types.ObjectId ,	
																																															'ref' : 'Continent' ,
																																																										'autopopulate' : true  , 'required' : [true , 'Continent ID for Sound should be provided.'] ,
																													'validate' : {
																																					'isAsync' : true ,
																																															'validator' : (v) => {
																							...
																							'region' : {	
																														'type' : Schema.Types.ObjectId ,	
																																															'ref' : 'Region' ,
																																																									'autopopulate' : true  , 'required' : [true , 'Region ID for Sound should be provided.'] ,
																													'validate' : {
																																					'isAsync' : true ,
																																															'validator' : (v) => {
																							...
																							'ethnic_group' : {	
																																	'type' : Schema.Types.ObjectId ,	
																																																		'ref' : 'Eyon' ,
																																																											'autopopulate' : true  , 'required' : [true , 'Eyon ID for Sound should be provided.'] ,
																																'validate' : {
																																								'isAsync' : true ,
																																																		'validator' : (v) => {
																									...
																									'about' : {
																															'type' : String ,
																																								'maxlength' : [2000 , 'About sound cannot be greater than 2000 characters in length.'] ,

																																							 		'required' : [true , 'About sound cannot be empty and should be provided.'] ,
																																															
																															 										 		'minlength' : [10 , 'About sound cannot be less than 10 characters in length.']			} ,

																											'author' : {
																																		'type' : Schema.Types.ObjectId ,
																																																			'ref' : 'User' ,
																																																												'autopopulate' : true , 'required' : [true , 'User ID for Sound should be provided.'] ,
																													'validate' : {
																																					'isAsync' : true ,
																																															'validator' : (v) => {
																								...
																								'artist' : {
																																'type' : String ,
																																									'maxlength' : [25 , 'Artist cannot be greater than 25 characters in length.'] ,
																																										
																																										'required' : [true , 'Artist cannot be empty and should be provided.'] ,
																															 										 		
																															 										 		'minlength' : [1 , 'Artist cannot be less than 1 character in length.']			} ,
...
soundSchema.plugin(require('mongoose-autopopulate'));
