...
extra = require('fs-extra') , key = '' , params = '' , errors = require('./errors/user') , userPhotos = require('./buckets/s3/user-photos') , userS3 = require('./buckets/s3/userS3') , bitmap = '' , 
...
module.exports = {
		...
		'reqOptions' : {		'url' : 'http://localhost:3000/api/user/' ,
																																		'method' : 'GET' ,
																																												'json' : {} ,
																																																			'qs' : {}			} ,
	...
	'delete' : (req , errArr) => {
			...
			errArr.push({
										...
										'param' : 'photo' ,
										'value' : '' ,
										'msg' : 'Image have to be re-uploaded due to invalid data in other field parameters.'
			});
						key = req.file.key;
																params = {'Bucket' : 'aremi-users-photo' , 'Key' : key };
