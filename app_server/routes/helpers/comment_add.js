...
router.get('/photo/:photo/comment/new'																,											photo.entryAddComment);

router.post('/photo/:photo/comment/new'																,											photo.entryAddCommentSubmit);



router.get('/art/:article/comment/new'																,											art.entryAddCommentArticle);

router.post('/art/:article/comment/new'																,											art.entryAddCommentSubmitArticle);
