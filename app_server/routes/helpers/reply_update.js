...
router.get('/photo/:photo/comment/:comment/reply/:reply/update'														,											photo.entryReplyUpdate);

router.post('/photo/:photo/comment/:comment/reply/:reply/update'													,											photo.entryReplyUpdateSubmit);



router.get('/art/:article/comment/:comment/reply/:reply/update'														,											art.entryReplyUpdateArticle);

router.post('/art/:article/comment/:comment/reply/:reply/update'													,											art.entryReplyUpdateSubmitArticle);
